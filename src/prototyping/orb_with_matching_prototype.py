...
img2 = cv2.imread(os.path.join(data_folder, 'img_163.png'), 0)  # TODO: look what kwarg 0 does, I think greyscaling.
...
img3 = cv2.drawMatches(img1,kp1,img2,kp2,matches[:50], outImg=None, flags=2)
